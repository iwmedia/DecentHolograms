package eu.decentsoftware.holograms.api.utils.scheduler.adapter;
...
public interface SchedulerAdapter {
     ...
     */
    BukkitTask runAsyncDelayed(Runnable runnable, long delay, TimeUnit unit);
     ...
     * @param runnable The task to execute.
     */
    BukkitTask runAtEntity(Entity entity, Runnable runnable);
     ...
     */
    BukkitTask runAtEntityDelayed(Entity entity, Runnable runnable, long delay);
